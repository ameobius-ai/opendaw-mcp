#!/usr/bin/env python3
"""E2E test for werkstatt_dimension_chorus.js DSP script."""
...
CODE = open(os.path.join(REPO_DIR, "scripts", "werkstatt_dimension_chorus.js")).read()
...
def run_test():
    ...
    try:
        ...
        async def test():
            ...
            # Test 3: compile dimension_chorus code
            ...
            await bridge.stop()
            print(f"werkstatt_dimension_chorus E2E: {passed}/{passed + failed}")
            return failed == 0
