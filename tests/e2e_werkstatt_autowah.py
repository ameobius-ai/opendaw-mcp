#!/usr/bin/env python3
"""E2E test for werkstatt_autowah.js DSP script."""
...
CODE = open(os.path.join(REPO_DIR, "scripts", "werkstatt_autowah.js")).read()
...
def run_test():
    ...
    try:
        ...
        async def test():
            ...
            await bridge.stop()
            print(f"werkstatt_autowah E2E: {passed}/{passed + failed}")
            return failed == 0
