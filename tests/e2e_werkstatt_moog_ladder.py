#!/usr/bin/env python3
"""E2E test for werkstatt_moog_ladder.js DSP script."""
...
CODE = open(os.path.join(os.path.dirname(SCRIPT_DIR), "scripts", "werkstatt_moog_ladder.js")).read()
...
def main():
    ...
    try:
        ...
        async def run():
            ...
            # Test 3: compile + check params (6: cutoff, resonance, drive, warmth, mode, mix)
            ...
            await bridge.stop()
            print(f"werkstatt_moog_ladder E2E: {passed}/{passed + failed}")
            return failed == 0
