#!/usr/bin/env python3
"""E2E test for werkstatt_convolution_reverb.js DSP script."""
...
CODE = open(os.path.join(os.path.dirname(SCRIPT_DIR), "scripts", "werkstatt_convolution_reverb.js")).read()
...
def main():
    ...
    try:
        ...
        async def run():
            ...
            await bridge.stop()
            print(f"werkstatt_convolution_reverb E2E: {passed}/{passed + failed}")
            return failed == 0
