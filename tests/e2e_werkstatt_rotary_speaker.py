#!/usr/bin/env python3
"""E2E test for werkstatt_rotary_speaker.js DSP script."""
...
CODE = open(os.path.join(os.path.dirname(SCRIPT_DIR), "scripts", "werkstatt_rotary_speaker.js")).read()
...
def main():
    ...
    try:
        ...
        async def run():
            ...
            await bridge.stop()
            print(f"werkstatt_rotary_speaker E2E: {passed}/{passed + failed}")
            return failed == 0
