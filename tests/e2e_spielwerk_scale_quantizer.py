#!/usr/bin/env python3
"""E2E test for spielwerk_scale_quantizer.js DSP script.
...
CODE = open(os.path.join(REPO_DIR, "scripts", "spielwerk_scale_quantizer.js")).read()
...
def run_test():
    ...
    try:
        ...
        async def test():
            ...
            # Test 3: compile scale_quantizer code
            ...
            if r3.get("compiled") and r3.get("paramCount") == 3:
                passed += 1
            else:
            ...
            await bridge.stop()
            print(f"spielwerk_scale_quantizer E2E: {passed}/{passed + failed}")
            return failed == 0
