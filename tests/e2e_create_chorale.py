...
def main():
    ...
    try:
        ...
        async def run():
            ...
            if "16" in r2_str:
                print("  ✅ test 3: 16 notes (4 chords × 4 voices)")
                passed += 1
            else:
            ...
            if "SATB" in r2_str:
                print("  ✅ test 4: SATB voices present")
                passed += 1
            else:
                print("  ❌ test 4: no SATB in output")
                failed += 1

            # 5. Check chord_count = 4
            if "4" in r2_str and "chord" in r2_str.lower():
                print("  ✅ test 5: 4 chords")
                passed += 1
            else:
                print("  ❌ test 5: chord count not 4")
                failed += 1
            ...
            if "success" in str(r6).lower() or "total_notes" in str(r6).lower():
                print("  ✅ test 6: 7th chord chorale created")
                passed += 1
            else:
            ...
            if "success" in str(r7).lower() or "total_notes" in str(r7).lower():
                print("  ✅ test 7: voice_spread chorale created")
                passed += 1
            else:
            ...
            if "Error" in str(r8):
                print("  ✅ test 8: invalid chord rejected")
                passed += 1
            else:
