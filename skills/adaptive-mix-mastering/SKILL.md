...
| When | Engine | Why |
|------|--------|-----|
| User says "opendaw" / "наш mcp" | openDAW MCP | agent-native, 377 tools, real-time |
...
- **openDAW MCP**: `~/projects/creative-studio/agent-daw/opendaw-mcp/venv/` (server.py, 377 tools)
...
- 377 MCP tools, 80+ orchestration tools, 108 DSP scripts
- See `opendaw-automation` skill for full API reference (377 tools)
...
### Related skills
- `opendaw-automation` — 377 MCP tools API reference
