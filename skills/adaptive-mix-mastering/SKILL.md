...
| When | Engine | Why |
|------|--------|-----|
| User says "opendaw" / "наш mcp" | openDAW MCP | agent-native, 382 tools, real-time |
...
- **openDAW MCP**: `~/projects/creative-studio/agent-daw/opendaw-mcp/venv/` (server.py, 382 tools)
...
- 382 MCP tools, 80+ orchestration tools, 108 DSP scripts
- See `opendaw-automation` skill for full API reference (382 tools)
...
### Related skills
- `opendaw-automation` — 382 MCP tools API reference
