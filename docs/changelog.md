...
- **`reverse_notes`** — new melodic variation tool: reverse note order in a region (retrograde). Positions are mirrored, durations/velocities preserved.
...
- ruff clean, 267 MCP tools, no regressions
