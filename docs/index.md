...
|---------|-------------|---------------------------|
| Tool count | 557 domain-specific | 5–20 generic |
...
- **557** MCP tools (`mcp_opendaw_*` prefix)
- **226** Python examples
...
The server connects to a headless Chromium instance running openDAW via Playwright. All 557 tools map to typed DAW operations through a bridge that injects typed helpers into the V8 context.
