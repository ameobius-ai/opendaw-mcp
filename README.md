...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-342-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-1951%20unit%20%2B%20E2E-brightgreen)](tests/)
[![Examples](https://img.shields.io/badge/Examples-114-blue)](examples/)
...
| | |
|---|---|
| **342** MCP tools | **114** Python examples (8 genre templates) |
| **98** DSP scripts | **11** agent skills |
| **3** framework wrappers | **1951** unit + E2E tests |
