...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-350-brightgreen)](TOOL_CATALOG.md)
[![Skills](https://img.shields.io/badge/Agent%20Skills-11-blue)](skills/)
[![DSP Scripts](https://img.shields.io/badge/DSP%20Scripts-100-orange)](scripts/)
[![Tests](https://img.shields.io/badge/Tests-2147%20unit%20%2B%20E2E-brightgreen)](tests/)
[![Examples](https://img.shields.io/badge/Examples-120-blue)](examples/)
...
| | |
|---|---|
| **350** MCP tools | **120** Python examples (8 genre templates) |
| **100** DSP scripts | **11** agent skills |
| **3** framework wrappers | **2147** unit + E2E tests |
