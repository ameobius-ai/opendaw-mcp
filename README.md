...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-346-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-2035%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **346** MCP tools | **118** Python examples (8 genre templates) |
| **98** DSP scripts | **11** agent skills |
| **3** framework wrappers | **2035** unit + E2E tests |
