...
**469 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **469** MCP tools | **175** Python examples (21 genre templates) |
...
|---------|-------------|-------------------|
| Full DAW control (469 tools) | ✅ | ❌ (1-10 tools) |
...
See [`TOOL_CATALOG.md`](TOOL_CATALOG.md) for the complete list of 469 tools with parameters and descriptions.
