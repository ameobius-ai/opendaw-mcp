...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-527-brightgreen)](TOOL_CATALOG.md)
...
**527 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **527** MCP tools | **176** Python examples (23 genre templates) |
