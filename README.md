...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-360-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-2373%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **360** MCP tools | **121** Python examples (8 genre templates) |
| **105** DSP scripts | **11** agent skills |
| **3** framework wrappers | **2373** unit + E2E tests |
