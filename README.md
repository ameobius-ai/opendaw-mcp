...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-368-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-2473%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **368** MCP tools | **121** Python examples (8 genre templates) |
| **107** DSP scripts | **11** agent skills |
| **3** framework wrappers | **2473** unit + E2E tests |
