...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-344-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-1990%20unit%20%2B%20E2E-brightgreen)](tests/)
[![Examples](https://img.shields.io/badge/Examples-117-blue)](examples/)
...
| | |
|---|---|
| **344** MCP tools | **117** Python examples (8 genre templates) |
| **98** DSP scripts | **11** agent skills |
| **3** framework wrappers | **1990** unit + E2E tests |
