...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-491-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-4914%20unit%20%2B%20E2E-brightgreen)](tests/)
...
**491 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **491** MCP tools | **175** Python examples (23 genre templates) |
| **111** DSP scripts | **12** agent skills |
| **3** framework wrappers | **4914** unit + E2E tests |
