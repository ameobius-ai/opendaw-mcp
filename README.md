...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-522-brightgreen)](TOOL_CATALOG.md)
[![Skills](https://img.shields.io/badge/Agent%20Skills-12-blue)](skills/)
[![DSP Scripts](https://img.shields.io/badge/DSP%20Scripts-130-orange)](scripts/)
...
**522 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **522** MCP tools | **176** Python examples (23 genre templates) |
| **130** DSP scripts | **12** agent skills |
