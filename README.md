...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-316-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-1331%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **316** MCP tools | **94** Python examples (8 genre templates) |
| **94** DSP scripts | **11** agent skills |
| **3** framework wrappers | **1331** unit + E2E tests |
