...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-322-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-1479%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **322** MCP tools | **94** Python examples (8 genre templates) |
| **98** DSP scripts | **11** agent skills |
| **3** framework wrappers | **1479** unit + E2E tests |
