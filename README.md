...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-481-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-4633%20unit%20%2B%20E2E-brightgreen)](tests/)
...
**481 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **481** MCP tools | **175** Python examples (21 genre templates) |
| **111** DSP scripts | **12** agent skills |
| **3** framework wrappers | **4633** unit + E2E tests |
