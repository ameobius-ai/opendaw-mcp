...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-502-brightgreen)](TOOL_CATALOG.md)
[![Skills](https://img.shields.io/badge/Agent%20Skills-12-blue)](skills/)
[![DSP Scripts](https://img.shields.io/badge/DSP%20Scripts-117-orange)](scripts/)
[![Tests](https://img.shields.io/badge/Tests-5158%20unit%20%2B%20E2E-brightgreen)](tests/)
...
**502 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **502** MCP tools | **175** Python examples (23 genre templates) |
| **117** DSP scripts | **12** agent skills |
| **3** framework wrappers | **5158** unit + E2E tests |
...
See [`TOOL_CATALOG.md`](TOOL_CATALOG.md) for the complete list of 481 tools with parameters and descriptions.
