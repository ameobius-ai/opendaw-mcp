...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-519-brightgreen)](TOOL_CATALOG.md)
...
**519 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **519** MCP tools | **176** Python examples (23 genre templates) |
| **129** DSP scripts | **12** agent skills |
