...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-329-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-1681%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **329** MCP tools | **94** Python examples (8 genre templates) |
| **98** DSP scripts | **11** agent skills |
| **3** framework wrappers | **1681** unit + E2E tests |
