...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-320-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-1422%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **320** MCP tools | **94** Python examples (8 genre templates) |
| **97** DSP scripts | **11** agent skills |
| **3** framework wrappers | **1422** unit + E2E tests |
