...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-374-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-1355%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **374** MCP tools | **122** Python examples (8 genre templates) |
| **108** DSP scripts | **12** agent skills |
| **3** framework wrappers | **1355** unit + E2E tests |
