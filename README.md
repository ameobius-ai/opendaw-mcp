...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-381-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-2648%20unit%20%2B%20E2E-brightgreen)](tests/)
...
**381 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **378** MCP tools | **123** Python examples (8 genre templates) |
| **109** DSP scripts | **12** agent skills |
| **3** framework wrappers | **1403** unit + E2E tests |
