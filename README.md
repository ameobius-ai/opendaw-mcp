...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-364-brightgreen)](TOOL_CATALOG.md)
[![Skills](https://img.shields.io/badge/Agent%20Skills-11-blue)](skills/)
[![DSP Scripts](https://img.shields.io/badge/DSP%20Scripts-107-orange)](scripts/)
[![Tests](https://img.shields.io/badge/Tests-2433%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **364** MCP tools | **121** Python examples (8 genre templates) |
| **107** DSP scripts | **11** agent skills |
| **3** framework wrappers | **2433** unit + E2E tests |
