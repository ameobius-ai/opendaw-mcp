...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-487-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-4818%20unit%20%2B%20E2E-brightgreen)](tests/)
...
**487 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **487** MCP tools | **175** Python examples (23 genre templates) |
| **111** DSP scripts | **12** agent skills |
| **3** framework wrappers | **4818** unit + E2E tests |
