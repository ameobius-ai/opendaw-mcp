...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-501-brightgreen)](TOOL_CATALOG.md)
...
**501 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **501** MCP tools | **175** Python examples (23 genre templates) |
