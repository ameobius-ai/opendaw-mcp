...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-337-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-1848%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **337** MCP tools | **114** Python examples (8 genre templates) |
| **98** DSP scripts | **11** agent skills |
| **3** framework wrappers | **1848** unit + E2E tests |
