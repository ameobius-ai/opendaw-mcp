...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-244-brightgreen)](TOOL_CATALOG.md)
...
**244 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
python server.py --list-tools  # list all 244 registered MCP tools
```
...
See [`TOOL_CATALOG.md`](TOOL_CATALOG.md) for the complete list of 244 tools with parameters and descriptions.
...
- **awesome-mcp PR updated** — title and body synced to 244 tools
...
- **244 total tools** (added `export_dry_stem` for freeze/flatten workflows)
...
- **TOOL_CATALOG.md regenerated from AST** — all 244 tools with descriptions, 32 categories
