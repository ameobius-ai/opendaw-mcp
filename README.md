...
**383 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **383** MCP tools | **123** Python examples (8 genre templates) |
| **110** DSP scripts | **12** agent skills |
| **3** framework wrappers | **2669** unit + E2E tests |
