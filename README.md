...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-319-brightgreen)](TOOL_CATALOG.md)
[![Skills](https://img.shields.io/badge/Agent%20Skills-11-blue)](skills/)
[![DSP Scripts](https://img.shields.io/badge/DSP%20Scripts-97-orange)](scripts/)
[![Tests](https://img.shields.io/badge/Tests-1404%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **319** MCP tools | **94** Python examples (8 genre templates) |
| **97** DSP scripts | **11** agent skills |
| **3** framework wrappers | **1404** unit + E2E tests |
