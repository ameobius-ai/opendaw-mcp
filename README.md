...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-352-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-2223%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **352** MCP tools | **121** Python examples (8 genre templates) |
| **102** DSP scripts | **11** agent skills |
| **3** framework wrappers | **2223** unit + E2E tests |
