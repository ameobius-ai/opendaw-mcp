...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-480-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-4610%20unit%20%2B%20E2E-brightgreen)](tests/)
...
**480 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **480** MCP tools | **175** Python examples (21 genre templates) |
| **111** DSP scripts | **12** agent skills |
| **3** framework wrappers | **4610** unit + E2E tests |
...
|---------|-------------|-------------------|
| Full DAW control (480 tools) | ✅ | ❌ (1-10 tools) |
...
See [`TOOL_CATALOG.md`](TOOL_CATALOG.md) for the complete list of 480 tools with parameters and descriptions.
