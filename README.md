...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-382-brightgreen)](TOOL_CATALOG.md)
[![Skills](https://img.shields.io/badge/Agent%20Skills-12-blue)](skills/)
[![DSP Scripts](https://img.shields.io/badge/DSP%20Scripts-110-orange)](scripts/)
[![Tests](https://img.shields.io/badge/Tests-2654%20unit%20%2B%20E2E-brightgreen)](tests/)
...
**385 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **387** MCP tools | **123** Python examples (8 genre templates) |
| **110** DSP scripts | **12** agent skills |
| **3** framework wrappers | **2705** unit + E2E tests |
...
|---------|-------------|-------------------|
| Full DAW control (298 tools) | ✅ | ❌ (1-10 tools) |
...
| `opendaw-automation` | API reference | 298 MCP tools full reference, bridge architecture, pitfalls, DSP script library (33 scripts), CodeRabbit review patterns. The base skill — others cross-reference it. |
...
See [`TOOL_CATALOG.md`](TOOL_CATALOG.md) for the complete list of 298 tools with parameters and descriptions.
