...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-363-brightgreen)](TOOL_CATALOG.md)
[![Skills](https://img.shields.io/badge/Agent%20Skills-11-blue)](skills/)
[![DSP Scripts](https://img.shields.io/badge/DSP%20Scripts-106-orange)](scripts/)
[![Tests](https://img.shields.io/badge/Tests-2412%20unit%20%2B%20E2E-brightgreen)](tests/)
...
| | |
|---|---|
| **363** MCP tools | **121** Python examples (8 genre templates) |
| **106** DSP scripts | **11** agent skills |
| **3** framework wrappers | **2412** unit + E2E tests |
