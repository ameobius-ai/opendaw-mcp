...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-315-brightgreen)](TOOL_CATALOG.md)
[![Skills](https://img.shields.io/badge/Agent%20Skills-11-blue)](skills/)
[![DSP Scripts](https://img.shields.io/badge/DSP%20Scripts-94-orange)](scripts/)
[![Tests](https://img.shields.io/badge/Tests-1314%20unit%20%2B%20E2E-brightgreen)](tests/)
[![Examples](https://img.shields.io/badge/Examples-113-blue)](examples/)
...
| | |
|---|---|
| **315** MCP tools | **94** Python examples (8 genre templates) |
| **94** DSP scripts | **11** agent skills |
| **3** framework wrappers | **1314** unit + E2E tests |
