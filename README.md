...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-348-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-2102%20unit%20%2B%20E2E-brightgreen)](tests/)
[![Examples](https://img.shields.io/badge/Examples-119-blue)](examples/)
...
| | |
|---|---|
| **348** MCP tools | **119** Python examples (8 genre templates) |
| **100** DSP scripts | **11** agent skills |
| **3** framework wrappers | **2102** unit + E2E tests |
