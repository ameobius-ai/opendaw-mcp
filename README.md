...
[![MCP Tools](https://img.shields.io/badge/MCP%20Tools-492-brightgreen)](TOOL_CATALOG.md)
...
[![Tests](https://img.shields.io/badge/Tests-5067%20unit%20%2B%20E2E-brightgreen)](tests/)
...
**497 MCP tools for agent-native control of [openDAW](https://github.com/andremichelle/openDAW) — a browser-based digital audio workstation.**
...
| | |
|---|---|
| **492** MCP tools | **175** Python examples (23 genre templates) |
| **114** DSP scripts | **12** agent skills |
| **3** framework wrappers | **5067** unit + E2E tests |
